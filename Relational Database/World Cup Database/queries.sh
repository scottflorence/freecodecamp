...
echo "$($PSQL "SELECT name FROM games, teams WHERE (games.winner_id = teams.team_id OR games.opponent_id = teams.team_id) AND year=2014 AND round='Eighth-Final' ORDER BY name;")"
